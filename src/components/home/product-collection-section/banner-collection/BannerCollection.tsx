  ...
  return (
    <div className=" font-bold w-full pt-20 pb-5 h-full">
      <div className="flex flex-col text-center gap-2">
        ...
        <p>
          <span className="font-inter font-extrabold text-sm md:text-5xl inline-block bg-[#F7F3F3] px-2 py-1">
        ...
        <p className="">
          <span className="text-[white] inline-block text-xs md:text-xl bg-[#042E2D] px-2 py-1 transform -rotate-2">
