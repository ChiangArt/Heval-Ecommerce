  ...
  return (
    <>
      ...
      <Information
        ...
        description1="Heval, una marca que simboliza la conexión y crecimiento de tres personas que  refleja unión y compañerismo en su deseo de escalar juntos la montaña de sus objetivos."
        bgColor="bg-[#042E2D]"
      />
      <ImageGallery imagenes={[{ src: "/banner2 (2).jpg", alt: "Tercera" }]} />
      <Information
